...
export default function CreateQuizz() {
  ...
  const getAuth = async () => {
    try {
      const res = await fetch("https://quiz-one-virid.vercel.app/admin/data", {
        method: "GET",
        headers: {
  ...
  const callquestion = async () => {
    try {
      const res = await fetch("https://quiz-one-virid.vercel.app/question", {
        method: "GET",
        headers: {
          Accept: "appllication/json",
          "Content-Type": "application/json",
  ...
  const deleteQuiz = async (id) => {
    ...
    if (confirmation) {
      const res = await fetch("https://quiz-one-virid.vercel.app/question/delete", {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const AddQuestion = async (e) => {
    ...
    if (addQue.answer == "Please Select" || addQue.answer == "") {
      ...
      const res = await fetch("https://quiz-one-virid.vercel.app/question/add", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
