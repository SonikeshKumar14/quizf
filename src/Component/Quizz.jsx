...
export default function Quizz() {
  ...
  const logout = () => {
    fetch("https://quiz-one-virid.vercel.app/student/logout", {
      method: "POST",
      headers: {
  ...
  const save = async () => {
    ...
    if (confirm) {
      const res = await fetch("https://quiz-one-virid.vercel.app/quizz/result", {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const calldata = async () => {
    try {
      const res = await fetch("https://quiz-one-virid.vercel.app/quizz", {
        method: "GET",
        headers: {
          Accept: "appllication/json",
          "Content-Type": "application/json",
